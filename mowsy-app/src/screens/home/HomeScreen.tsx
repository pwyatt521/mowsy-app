      ...
      >
        ...
        <View style={styles.quickActions}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <Card style={styles.actionCard} onPress={() => {
              ...
              linkTo('/equipment/add-equipment');
            }}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Button title="See All" variant="text" size="small" onPress={() => navigation.navigate('Jobs')} />
          </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Button title="See All" variant="text" size="small" onPress={() => navigation.navigate('Equipment')} />
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <EquipmentCard
              title="Honda Mower"
